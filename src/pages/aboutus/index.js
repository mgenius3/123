        ...
        <div className={styles.container}>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.subsidiary}>
              ...
              <div className={styles.imagelist}>
                <div
                  className={styles.homesimage1 + " " + "bg_animation"}
                ></div>
                <div
                  className={styles.homesimage2 + " " + "bg_animation"}
                ></div>
              </div>
            </div>
            ...
            <div className={styles.subsidiary}>
              <div>
                <h3>231 Records</h3>
                <p>
                  Founded out of a passion for music and the arts, 231 Records
                  is a leading record label and music production company. We
                  provide comprehensive services to artists and musicians,
                  including recording studios equipped with state-of-the-art
                  technology, artist development programs, marketing strategies,
              ...
              <div className={styles.imagelist}>
                <div
                  className={styles.recordimage1 + " " + "bg_animation"}
                ></div>
                <div
                  className={styles.recordimage2 + " " + "bg_animation"}
                ></div>
              </div>
            </div>
          </section>
